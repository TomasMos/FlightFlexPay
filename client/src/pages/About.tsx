...
function ScrollAnimation({ children, variant = fadeInUp, delay = 0, className = "" }: { 
...
function WatermarkLogo({ sectionRef }: { sectionRef: React.RefObject<HTMLElement> }) {
...
function WatermarkImage({ src, alt, rotate = -15, opacity = 0.35, sectionRef }: {
  src: string;
  alt: string;
  rotate?: number;
  opacity?: number;
...
function WatermarkImageLeft({ src, alt, rotate = -15, opacity = 0.35, sectionRef }: {
  src: string;
  alt: string;
  rotate?: number;
  opacity?: number;
...
<p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed">
  ...
  without debt, credit cards, or hidden fees.
      ...
      {/* The Splickets Story */}
      <section ref={storySectionRef} className="py-16 bg-white relative overflow-x-hidden overflow-y-visible">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              <ScrollAnimation variant={fadeInRight} delay={0.3}>
                <div className="relative">
                  <div className="aspect-square bg-cover bg-no-repeat bg-center rounded-2xl" style={{ backgroundImage: `url(${about1})` }}>
                  </div>
                </div>
              </ScrollAnimation>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {values.map((value, index) => (
                  <ScrollAnimation key={index} variant={scaleIn} delay={index * 0.1}>
                    <Card className="p-6 border-2 hover:shadow-lg transition-shadow" data-testid={`value-card-${index}`}>
      ...
      {/* Global Presence */}
      <section ref={globalSectionRef} className="py-16 bg-gray-50 relative overflow-x-hidden overflow-y-visible">
        <WatermarkImage src={frame2} alt="Travel icon" rotate={15} opacity={0.35} sectionRef={globalSectionRef} />
        <div className="container mx-auto px-4 relative z-10">
      ...
      <section ref={visionSectionRef} className="py-16 bg-white relative overflow-x-hidden overflow-y-visible">
        <WatermarkImageLeft src={frame3} alt="Travel icon" rotate={-15} opacity={0.35} sectionRef={visionSectionRef} />
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
