  ...
  return (
    <nav className="bg-white shadow-sm border-b border-gray-200">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/">
            <div className="flex items-center space-x-2 cursor-pointer" data-testid="navbar-logo">
              ...
              <span className="text-xl font-bold text-gray-900">FlightPay</span>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {import.meta.env.DEV && (
              <Link href="/email-test">
                <Button variant="ghost" data-testid="nav-link-email-test">
                  Email Test
                </Button>
              </Link>
            )}
            ...
            {currentUser ? (
              ...
              <Link href="/signin">
                <Button data-testid="nav-link-signin">
                  Sign In
                </Button>
              </Link>
            )}
        ...
        {/* Mobile Navigation */}
        {isMobileMenuOpen && (
          <div className="md:hidden pb-4 border-t border-gray-200 mt-2 pt-4" data-testid="mobile-menu">
              ...
              {import.meta.env.DEV && (
                <Link href="/email-test">
                  <Button 
                    ...
                    className="w-full justify-start"
                    onClick={() => setIsMobileMenuOpen(false)}
                    data-testid="mobile-nav-email-test"
                  >
                    Email Test
                  </Button>
                </Link>
